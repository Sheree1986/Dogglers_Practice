...
public final class GridListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView dogPhoto;

  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView dogAge,
      @NonNull TextView dogHobby, @NonNull TextView dogName, @NonNull ImageView dogPhoto) {
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.dog_photo;
      ImageView dogPhoto = rootView.findViewById(id);
      if (dogPhoto == null) {
        break missingId;
      }
